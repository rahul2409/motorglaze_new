          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Kits Ordered</strong>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Cars glass-coated</strong>
            ...
            <!-- <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">New Invoices</strong>
            ...
            <div class="col-lg-4 col-md-12">
              ...
              <div id="new-updates" class="card updates recent-updated">
                <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                  <h2 class="h5 display"><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box">Registered Users</a></h2><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box"><i class="fa fa-angle-down"></i></a>
                </div>
                <div id="updates-box" role="tabpanel" class="collapse show">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, autem. Quia, laboriosam provident sit incidunt ea porro, ex atque distinctio assumenda nisi ipsa, laudantium labore molestiae obcaecati. Dolorum, tempora dolores.</p>
                </div>
              </div>
