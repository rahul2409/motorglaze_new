 ...
 */
$notificationSubject = 'Arrays example';
 ...
 * Validators: Required
 */
$singleLevelArrayField1 = new Quform_Element('single_level[field1]');
 ...
 */
$secondLevelArrayField1 = new Quform_Element('first_level[second_level][field1]');
$secondLevelArrayField1->addValidators(array('required', 'digits'));
$secondLevelArrayField1->addFilters(array('trim'));
$secondLevelArrayField1->setIsArray(true);
 ...
 * Validators: Required, Digits
 */
$secondLevelArrayField2 = new Quform_Element('first_level[second_level][field2]');
$secondLevelArrayField2->addValidators(array('required', 'digits'));
$secondLevelArrayField2->addFilters(array('digits', 'trim'));
$secondLevelArrayField2->setIsArray(true);
