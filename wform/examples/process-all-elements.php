 ...
 */
$notificationSubject = 'All elements example';
 ...
 * Validators: Required
 */
$text = new Quform_Element('text_input');
$text->addFilter('trim');
$text->addValidator('required');
 ...
 * Validators: Required
 */
$singleSelect = new Quform_Element('single_select');
 ...
 * Validators: Required
 */
$multiSelect = new Quform_Element('multi_select[]');
 ...
 * Validators: Required
 */
$singleCheckbox = new Quform_Element('single_checkbox');
$singleCheckbox->addFilter('trim');
$singleCheckbox->addValidator('required');
$form->addElement($singleCheckbox);

/**
 * Configure the multi checkbox field
 * Filters: None
 * Validators: Required
 */
$multiCheckbox = new Quform_Element('multi_checkbox[]');
 ...
 * Validators: Required
 */
$radioButton = new Quform_Element('radio_button');
 ...
 * Validators: Required
 */
$textarea = new Quform_Element('textarea_input');
